...
class dao
{
    ...
    {
        if(!empty(dao::$errors)) { a(dao::$erros); die('dao query'); } //return new PDOStatement();   // If any error, return an empty statement object to make sure the remain method to execute.
...
//        {
          ...
          {  
            ...
            $sql = "select count(*) as recTotal from ($sql) a";
          } 
...
//        }
    ...
    {
        if(!empty(dao::$errors)) { a(dao::$errors);die('dao exec');}//return new PDOStatement();   // If any error, return an empty statement object to make sure the remain method to execute.
