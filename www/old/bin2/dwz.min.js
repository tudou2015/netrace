...
$(">div",node).prepend("<div class='"+((op.showSub&&!op.ckbox)?op.coll:op.exp)+"'></div>"+(op.ckbox?"<div class='ckbox "+checked+"'></div>":"")+(op.icon?"<div class='"+((op.showSub&&!op.ckbox)?op.options.folderColl:op.options.folderExp)+"'></div>":""));(op.showSub&&!op.ckbox)?tree.show():tree.hide();
